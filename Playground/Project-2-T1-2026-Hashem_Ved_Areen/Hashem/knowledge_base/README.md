...
| File | Source | Content |
|------|--------|---------|
| `as_nzs_1158_p_categories.md` | AS/NZS 1158.3.1:2020 | Pedestrian / cycle / road / public-space / car-park subcategories (PP, PR, PA, PC, PE) with lux, UE2 uniformity, spacing rules |

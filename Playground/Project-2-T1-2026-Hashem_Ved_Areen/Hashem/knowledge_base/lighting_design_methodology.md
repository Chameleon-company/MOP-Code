...
### Step 2: Subcategory Selection (AS/NZS 1158.3.1:2020)
Based on the classification:
- V-category (V1-V5) for roads where vehicular traffic is the primary concern (AS/NZS 1158.1.1)
- Category P subcategories for pedestrian areas (AS/NZS 1158.3.1:2020):
  - **PP1-PP5** for pedestrian / cycle pathways (Table 3.4)
  - **PR1-PR6** for local roads (Table 3.3)
  - **PA1-PA3** for public activity areas (Table 3.5)
  - **PC1-PC3** for outdoor car parks (Table 3.7)
  - **PE1-PE3** for connecting elements such as subways and ramps (Table 3.6)
- Select the appropriate subcategory based on activity level and risk assessment

### Step 3: Determine Lighting Requirements
From the selected subcategory, extract:
- Average maintained horizontal illuminance Eh (lux)
- Point horizontal illuminance EPh (lux)
- Uniformity UE2 (max/avg ratio, *lower* is better — changed from the 2005 standard's Emin/Eavg)
- Vertical illuminance EPv (if applicable for facial recognition)
- Surround illuminance EPhS (for pathways, Table 3.4 column 6)
...
- Common for residential streets (PR2-PR5)

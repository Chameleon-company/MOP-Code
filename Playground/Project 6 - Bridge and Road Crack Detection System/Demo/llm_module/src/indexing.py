...
class InspectionPayload:
    ...
    Args:
        ...
        largest_crack_est_length: Estimated total crack length in pixels.
    ...
    largest_crack_est_length: float
    severity: str
    damage_level: float
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "InspectionPayload":
        ...
        required = [
            ...
            "largest_crack_est_length", "severity", "damage_level",
        ]
        missing = []
        for i in required:
            if i not in data:
        ...
        return cls(
            ...
            largest_crack_est_length=float(data["largest_crack_est_length"]),
            severity=severity,
    ...
    def to_semantic_query(self) -> str:
        ...
        query = (
            ...
            f"estimated length {self.largest_crack_est_length:.0f}px "
...
#     "largest_crack_est_length": 438.0,
#     "severity": "high",
#     "damage_level": 6.75,
# })

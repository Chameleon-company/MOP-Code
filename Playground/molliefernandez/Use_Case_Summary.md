...
| Urban Development Analysis | Ready to Publish T3 2023 | `requests.get()` | Wing Sum Wong and Jennifer Yau | Requests API key input, API key visible. Style Guide visible. Trello Card Created |
| Pedestrains Counts and Bus-stops | Ready to Publish T3 2023 | `pd.read_csv()` and `requests.get()` | Shilpa Sharma | Trello Card Created |
| Litter Traps & Public BBQ | Ready to Publish T3 2023 | `pd.read_csv()` | Tharusha Cao and Thomas Warren | Trello Card Created |
| Real-time parking hotspots | Ready to Publish T2 2023 | `requests.get()` | Siju Deng | Requests API key input, API key visible. Trello Card Created |
| Smart Bin Waste_Collection AI Application | Ready to Publish T2 2023 | `pd.read_csv()` | Barry Chen | Trello Card Created |
| Urban Bar Explorer | Ready to Publish T2 2023 | `requests.get()` | Keefe ALpay and Nathan Clee | Needs to be edited, the style guide is showing |
| Urban Art Explorer | Ready to Publish T2 2023 | `requests.get()` | Keefe Alpay and Nathan Clee | Needs to be edited, the style guide is showing |

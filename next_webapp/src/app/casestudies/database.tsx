const caseStudies = [
    ...
    { id: 6, title: 'Case Study 6', content: 'Content for Case Study 6...', group: 'EV' },
    { id: 7, title: 'Case Study 7', content: 'Content for Case Study 7...' , group: 'EV'},
    ...
    // ...and so on until the desired number of case studies has been reached
  ];

...
const Statistics = () => {
   ...
   const themeStyles = {
    ...
    // Other styles can be added here based on theme
    };
  ...
  const options = {
    ...
    return (
        <div style={{ margin: '0 auto', minHeight: '100vh', display: 'flex', flexDirection: 'column' }} className="font-sans bg-gray-100 text-black">
            <Header/>
            <h1 style={themeStyles} className='text-7xl font-bold px-[2rem] pt-[1rem] pb-[4rem]'>Statistics</h1>
                <div style={themeStyles} className='flex '>
            ...
            <main style={{ flex: '1 0 auto', width: '100%' }}>
                <div style={{ ...themeStyles, padding: '0 50px' }}>
                    <section >
                        <select 
                            value={tagFilter} 
                        ...
                        <select value={yearFilter} onChange={(e) => setYearFilter(e.target.value)} className="p-2 m-2 border shadow-lg"  style={themeStyles}>
                        ...
                        <select value={trimesterFilter} onChange={(e) => setTrimesterFilter(e.target.value)} className="p-2 m-2 border shadow-lg"  style={themeStyles}>
                        ...
                        <div className='flex' >
                                <div style={themeStyles} className='border-solid bg-white shadow-2xl border-2 border-black-600 py-8 px-10 my-10'>
                        ...
                        <input
                            ...
                            <table  className="min-w-full bg-white">
                                <thead >
                                    <tr>
                                        <th style={themeStyles} className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider rounded-tl-lg">
                                            ID
                                        </th>
                                        <th style={themeStyles} className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider rounded-tl-lg">
                                            Tag
                                        </th>
                                        <th  style={themeStyles} className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Number of Case Studies Published
                                        </th>
                                        <th  style={themeStyles} className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider rounded-tr-lg">
                                            Popularity
                                        </th>
                                        <th style={themeStyles} className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Year
                                ...
                                <tbody>
                                    {records.filter((item)=>{
                                        ...
                                        <tr  style={themeStyles} key={study.id} className={index % 2 === 0 ? 'bg-gray-100' : 'bg-white'}>
                        ...
                        <nav  style={themeStyles} className='bg-gray-200 py-3'>
                            <ul className = 'pagei'>
                            <li className='page-item'>
                                ...
                                <li  className='float-right py-2'>
                                    <select  style={themeStyles} value={pagefilter} 

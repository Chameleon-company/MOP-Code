...
export default function UseCasesPage() {
  ...
  const filteredUseCases = useMemo(() => {
    ...
    if (!keyword) return useCaseData;

    return useCaseData.filter((item) => {
      return (
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <button className="inline-flex w-fit items-center gap-2 rounded-md bg-[#2DBE6C] px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-[#25a85e]">
          <Plus size={16} />
          Add New
        </button>
      </div>
      ...
      <div className="rounded-2xl border border-[#E4E7EC] bg-white p-4 shadow-sm">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <button className="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-[#E4E7EC] bg-[#F9FAFB] text-[#667085] transition hover:bg-[#F2F4F7]">
            <Filter size={16} />
          </button>
        </div>
      </div>
                  ...
                  >
                    ...
                    <td className="px-4 py-4 align-top">
                      <div className="flex items-center gap-3">
                        <button className="text-[#2DBE6C] transition hover:text-[#25a85e]">
                          <Pencil size={16} />
                        </button>
                        <button className="text-[#F04438] transition hover:text-[#d92d20]">
                          <Trash2 size={16} />
                        </button>
                      </div>
                    </td>

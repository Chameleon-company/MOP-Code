...
const About = () => {
  ...
  return (
    ...
    <div className="bg-white dark:bg-pr_bg_dark">
      <Header />
      ...
      <div className="w-full bg-gray-100   py-2 text-center mt-96 text-black dark:bg-sc_bg_dark dark:text-white">
        <h2 className="text-4xl font-semibold p-5">{t("About MOP")}</h2>
        <p className="font-normal text-xl mb-3 p-5">{t("p1")}</p>
      </div>

      <div className="m-4 bg-white dark:bg-pr_bg_dark dark:text-white">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mx-10 mt-10 ">
          <div
             //style={{ backgroundColor: "rgb(255,255,255)", color: "black" }}
            className="flex flex-col items-center p-4 shadow-xl rounded-sm h-full bg-white text-black dark:bg-[#3C3636] dark:text-white"
          >
          ...
          <div
            ...
            className="flex flex-col items-center border-black shadow-xl  bg-[#4ADE80] p-4 h-full dark:bg-[#3A714E]"
          >
            <div className="flex flex-row h-full ">
              <span className="font-bold m-2 text-3xl">

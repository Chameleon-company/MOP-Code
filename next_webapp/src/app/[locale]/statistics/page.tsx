      ...
      {isLoading ? (
        <div className="flex flex-1 items-center justify-center py-20">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Loading statistics...</p>
          </div>
        </div>
      ) : hasError ? (
        <div className="flex flex-1 items-center justify-center px-8 py-20">
          <div className="rounded-2xl border border-dashed border-red-200 bg-red-50 px-6 py-12 text-center dark:border-red-900 dark:bg-red-950/20">

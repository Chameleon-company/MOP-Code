      ...
      <main>
        <div>
          ...
          <table>
            <tr>
              <td>
                <img src="/img/people.png" alt="People" width="220px" />
              </td>
              <td></td>
              <td>
                <img src="/img/cloud.png" alt="Cloud" width="220px" />
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <img src="/img/recycle.png" alt="Recycle" width="220px" />
              </td>
              <td>
                {" "}
                <div class="container">
                  <div class="table_top hover:bg-green-200">Sensors</div>
                  <div class="table_bottom hover:bg-green-200">
                    Transportation
                  </div>
                </div>
              </td>
            ...
            <tr>
              <td>
                <img src="/img/house.png" alt="House" width="220px" />
              </td>
              <td>
                <div class="container">
              ...
              <td>
                <img src="/img/tram.png" alt="Tram" width="220px" />
              </td>
            </tr>
          </table>
        </div>

            ...
            <div className="left-content w-full md:w-1/2 p-6 md:p-10">
              <div>
                ...
                <ul className="list-disc pl-5">
                  <li>
                    You must use the website in accordance with applicable laws
                    and regulations.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    the website if you violate these terms.
                  </li>
                </ul>
              </div>
              <br />
              <div>
                ...
                <br />
                <p>
                  We grant you a limited, non-exclusive, and revocable license
                  to access and use our website for personal and non-commercial
                  purposes. This license does not include the right to:
                </p>
                <br />
                <ul className="list-disc pl-5">
                  <li>
                    Modify, adapt, or reverse engineer any part of the website.
                  </li>
                  <li>Copy or distribute content without permission.</li>
                  <li>
                    Engage in any activity that disrupts the normal functioning
                    of the website.
                  </li>
                </ul>
                <br />
                ...
                <br />
                <p>
                  We reserve the right to terminate your license and access to
                  the website at our discretion. Upon termination, you must
                  cease using the website, and any provisions of this agreement
            ...
            <div className="right-content justify-self-auto w-full md:w-1/2 p-6 md:p-10">
              <div>
                ...
                <p>
                  ...
                  multimedia elements, is owned by MOP. You may not use,

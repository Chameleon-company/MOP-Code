...
.dark .hero-image-container::before {
  background:
    linear-gradient(to bottom, rgba(38,50,56,0.2) 0%, transparent 35%, rgba(38,50,56,0.75) 100%),
    linear-gradient(to right, rgba(38,50,56,0.7) 0%, rgba(38,50,56,0.2) 50%, rgba(38,50,56,0.7) 100%);
}

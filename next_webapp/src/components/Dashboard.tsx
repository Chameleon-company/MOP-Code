            ...
            <div className="main-wrapper">
                <div className="main-container">
                    <section className="hero-section">
                        ...
                        {
                            /* <img src="https://i.postimg.cc/MpNvHDGf/Melburnian-Skyline.jpg" /> */
                        }

                    </section>
                    <section className="sign-up-btn-section">
                        <button className="sign-up-btn"><a href="signup.html"> Sign Up</a></button>
                    </section>
                    <section className="our-vision-section">
                        ...
                        <div className="img-div">
                            ...
                            {
                                /* <img src="https://i.postimg.cc/CMtf2SGV/Melbourne-HERO.jpg" /> */
                            }
                        </div>

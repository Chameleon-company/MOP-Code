...
const Dashboard = () => {
   ...
   useEffect(() => {
      handleSearch("T2 2024", SEARCH_MODE.TERM, CATEGORY.ALL);
   }, []);
   ...
   const handleSearch = async (
      ...
      // const res = await searchUseCases({ searchTerm: "T2 2024", searchMode: SEARCH_MODE.TERM, category });
            ...
            <div className="main-container">
               ...
               <section className="case-studies mx-10">
                  <Carousel responsive={responsive}>
                     {filteredCaseStudies.slice(5, 20).map((study) => (
                        <div
                           key={study.id}

    ...
    return (
        <header style={headerStyles.headerContainer}>
            ...
            <div style={headerStyles.navContainer}>
                <Link href="/" style={headerStyles.navLink}>Home</Link>
                <Link href="/casestudies" style={headerStyles.navLink}>Case Studies</Link>
                <Link href="/datasets" style={headerStyles.navLink}>Datasets</Link>
            </div>
        </header>
    );
};

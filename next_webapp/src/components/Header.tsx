...
const Header = ({ showSignUpButton = true }) => {
          ...
          <div className="md:flex items-center justify-between">
            <div className="md:flex items-center md:pl-[20rem]">
              ...
              <div
                ...
                className="w-10 h-7 absolute right-8 top-6 cursor-pointer md:hidden"
              >
                {isOpen ? <HiMiniXMark className="size-8" /> : <CiMenuBurger className="size-6" />}
              </div>
              <ul
                className={`md:flex justify-between md:pl-9 bg-green-400 md:w-auto w-full absolute md:static md:z-auto z-[1] ${isOpen ? 'top-18' : 'top-[-430px]'
                  }`}
              >
                <li className="">
                  <a
            ...
            <ul
              className={`md:flex justify-between md:pl-9 absolute bg-green-400 md:pr-[15rem] ml-0 py-5 md:w-auto w-full md:static md:z-auto z-[1] ${isOpen ? 'top-[21rem]' : 'top-[-430px]'
                }`}
            >
              <li className="">

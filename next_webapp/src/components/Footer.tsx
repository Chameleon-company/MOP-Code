...
import { FaFacebook, FaLinkedin, FaTwitter } from "react-icons/fa"; // Corrected Twitter import

const Footer = () => {
  const t = useTranslations("common");

  return (
    <footer className="bg-green-500 dark:bg-green-800 text-white py-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 md:space-x-8">
          ...
          <div className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-6">
            ...
            <a
              ...
              className="flex items-center hover:underline text-gray-300 dark:text-gray-400"
            >
              Melbourne Open Data
              <svg

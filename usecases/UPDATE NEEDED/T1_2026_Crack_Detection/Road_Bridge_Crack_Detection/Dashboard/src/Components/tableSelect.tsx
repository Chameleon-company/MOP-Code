...
const columns: GridColDef[] = [
  ...
  { field: 'damagelevel', headerName: 'Damage Level', width: 100},
  { field: 'reportstatus', headerName: 'Report Status', width: 100},
  { field: 'riskassessment', headerName: 'Risk Assessment', width: 330 },
  { field: 'repairactions', headerName: 'Recommended Repair', width: 330 },
  { field: 'inspectionschedule', headerName: 'Inspection Schedule', width: 330 }
]

...
model.load_state_dict(torch.load('depth/models/depth_vits.pth', map_location='cpu'))
...
results = model_yolo.predict(source="depth/test/pic/BDouble_10_1.jpg",save=False,device='cpu',conf=0.4)
